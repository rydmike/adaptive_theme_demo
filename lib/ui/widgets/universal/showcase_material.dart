...
class ShowcaseMaterial extends StatefulWidget {
  const ShowcaseMaterial({super.key});

  @override
  State<ShowcaseMaterial> createState() => _ShowcaseMaterialState();
}

class _ShowcaseMaterialState extends State<ShowcaseMaterial> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                TextThemeShowcase(showDetails: showDetails),
              ],
            ),
          ),
        ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                PrimaryTextThemeShowcase(showDetails: showDetails),
              ],
            ),
          ),
        ),
...
class SwitchShowcase extends StatefulWidget {
  const SwitchShowcase({super.key, this.showCupertinoSwitches = true});
        ...
        children: <Widget>[
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: 'Hint: Write something...',
              labelText: 'Text input with icons',
          ...
          if (explain)
            Padding(
              ...
              child: Text(
                ...
                'In M3 background defaults to colorScheme.surfaceContainerLow '
                'and in Flutter 3.22 and later it no longer gets elevation '
                'based surfaceTint by default, but it can still be used if '
                'surfaceTint is given a none transparent color. '
                'In M2 surfaceTint has no '
